...
public class Bar2 {
    public static void main(String[] args) {
       ...
       /* System.out.println("----------  Are Local Variables set to default values?? --------------");
        System.out.println("mainByte = " + mainByte); //not initialized
        System.out.println("mainChar = " + mainChar); //not initialized
        System.out.println("mainShort = " + mainShort); //not initialized
        System.out.println("mainInt = " + mainInt);//not initialized
